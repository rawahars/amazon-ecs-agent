...
// mibIfEntryLevel specifies the level of interface information to retrieve.
// https://learn.microsoft.com/en-us/windows/win32/api/netioapi/nf-netioapi-getifentry2ex
type mibIfEntryLevel uint32

// mibIfTable2 is the structure which contains the logical and physical interfaces on a local system.
