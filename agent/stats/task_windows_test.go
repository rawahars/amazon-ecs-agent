...
import (
	...
	mock_statsretriever "github.com/aws/amazon-ecs-agent/agent/stats/statsretriever/mock"
...
func TestTaskStatsCollection(t *testing.T) {
	...
	mockStatsRetriever := mock_statsretriever.NewMockStatsRetriever(ctrl)
	...
	taskStats := &StatsTask{
		...
		statsRetriever: mockStatsRetriever,
	}
	...
	mockStatsRetriever.EXPECT().GetNetworkAdapterStatisticsPerContainer(deviceName, numberOfContainers).Return(expectedNetworkStats, nil)
